...
xpkg.build.provider-demo: do.build.images
...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Demo CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Demo controllers
...
# This target prepares repo for your provider by replacing all "demo"
